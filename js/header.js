function displayHeader() {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            <div id="colorlib-logo"><a href="/" title="home" onclick="$.fn.fullpage.moveTo(1)">\
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                <a href="' + result[i].link + '">' + result[i].name + '</a></li>';
                    ...
                    htmlStr += '<li>\
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SIGs</a>\
