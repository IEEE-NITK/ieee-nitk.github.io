...
### What _is_ the data?
To understand the data, we need to first understand how NASA detect planets.  
...
:-------------------:|:------------------:|:--------------------:
![](/blog/assets/img/space-ml/lightcurve.png)  |![](/blog/assets/img/space-ml/foldedcurve.png)| ![](/blog/assets/img/space-ml/binnedcurve.png)
