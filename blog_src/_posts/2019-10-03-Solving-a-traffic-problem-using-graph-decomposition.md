...
author_github: appu234
date: 2019-10-14 22:29:00
image: '/assets/img/'
...
## **The idea of a graph**
![A graph on three vertices](/blog_src/assets/img/Decomposition-of-graphs/basic.jpg)
...
![Sample graph](/blog_src/assets/img/Decomposition-of-graphs/dfs1.jpg)

When we run DFS on the graph, we start at some vertex of the graph, say, A. We then explore A:

**A is visited**
![A is visited](/blog_src/assets/img/Decomposition-of-graphs/dfs2.jpg)

**B is visited**
![B is visited](/blog_src/assets/img/Decomposition-of-graphs/dfs3.jpg)

**C is visited**
![C is visited](/blog_src/assets/img/Decomposition-of-graphs/dfs4.jpg)

**D is visited**
![D is visited](/blog_src/assets/img/Decomposition-of-graphs/dfs5.jpg)
...
>
![Sample graph](/blog_src/assets/img/Decomposition-of-graphs/connectedness.jpg)
...
![Pre and Post visits](/blog_src/assets/img/Decomposition-of-graphs/prepost.jpg)
...
**_Clock = 1:_**
![Clock = 1](/blog_src/assets/img/Decomposition-of-graphs/clock1.jpg)

**_Clock = 2:_**
![Clock = 2](/blog_src/assets/img/Decomposition-of-graphs/clock2.jpg)

**_Clock = 3:_**
![Clock = 3](/blog_src/assets/img/Decomposition-of-graphs/clock3.jpg)

**_Clock = 4:_**
![Clock = 4](/blog_src/assets/img/Decomposition-of-graphs/clock4.jpg)

**_Clock = 5:_**
![Clock = 5](/blog_src/assets/img/Decomposition-of-graphs/clock5.jpg)

**_Clock = 6:_**
![Clock = 6](/blog_src/assets/img/Decomposition-of-graphs/clock6.jpg)

**_Clock = 7:_**
![Clock = 7](/blog_src/assets/img/Decomposition-of-graphs/clock7.jpg)

**_Clock = 8:_**
![Clock = 8](/blog_src/assets/img/Decomposition-of-graphs/clock8.jpg)

**_Clock = 9:_**
![Clock = 9](/blog_src/assets/img/Decomposition-of-graphs/clock9.jpg)
...
![Final](/blog_src/assets/img/Decomposition-of-graphs/final.png)

## **Directed Graphs(DiGraphs)**

![Sample graph](/blog_src/assets/img/Decomposition-of-graphs/digraph.jpg)
...
![SCCs](/blog_src/assets/img/Decomposition-of-graphs/scc.jpg)
...
![Metagraph](/blog_src/assets/img/Decomposition-of-graphs/metagraph.jpg)
...
**G:**
![SCC](/blog_src/assets/img/Decomposition-of-graphs/scc.jpg)

**G<sup>R</sup>:**
![SCCR](/blog_src/assets/img/Decomposition-of-graphs/sccr.jpg)

We first assign pre and post visit numbers to every vertex:
![SCC pre post](/blog_src/assets/img/Decomposition-of-graphs/sccprepost.jpg)
...
![SCC1](/blog_src/assets/img/Decomposition-of-graphs/scc1.jpg)
...
![SCC2](/blog_src/assets/img/Decomposition-of-graphs/scc2.jpg)

We continue this process until we have found all the SCCs:
![SCC3](/blog_src/assets/img/Decomposition-of-graphs/scc3.jpg)

And finally:
![SCC4](/blog_src/assets/img/Decomposition-of-graphs/scc4.jpg)
