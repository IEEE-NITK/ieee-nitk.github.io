var Zepto = function() {
    ...
    function d(t, e, n) {
        for (E in e) n && (o(e[E]) || W(e[E])) ? (o(e[E]) && !o(t[E]) && (t[E] = {}), W(e[E]) && !W(t[E]) && (t[E] = []), d(t[E], e[E], n)) : e[E] !== w && (t[E] = e[E])
    }
    ...
    return Q.matches = function(t, e) {
        ...
        var r, i = t.parentNode,
            o = !i;
        return o && (i = X).appendChild(t), r = ~Q.qsa(i, e).indexOf(t), o && X.removeChild(t), r
    }, C = function(t) {
        ...
        var r, i, a;
        return Z.test(t) && (r = j(A.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(H, "<$1></$2>")), e === w && (e = I.test(t) && RegExp.$1), e in z || (e = "*"), a = z[e], a.innerHTML = "" + t, r = j.each(N.call(a.childNodes), function() {
            a.removeChild(this)
        ...
        if (!t) return Q.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && I.test(t)) r = Q.fragment(t, RegExp.$1, n), t = null;
            else {
            ...
            else if (I.test(t)) r = Q.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== w) return j(n).find(t);
                r = Q.qsa(A, t)
            }
        ...
        ready: function(t) {
            return J.test(A.readyState) && A.body ? t(j) : A.addEventListener("DOMContentLoaded", function() {
                t(j)
            }, !1), this
        },
        get: function(t) {
            return t === w ? N.call(this) : this[t >= 0 ? t : t + this.length]
        },
        toArray: function() {
            return this.get()
        },
        ...
        not: function(t) {
            ...
            if (e(t) && t.call !== w) this.each(function(e) {
                ...
                var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? N.call(t) : j(t);
        ...
        find: function(t) {
            ...
            }) : 1 == this.length ? j(Q.qsa(this[0], t)) : this.map(function() {
                return Q.qsa(this, t)
            }) : j()
        },
        closest: function(t, e) {
            var n = this[0],
                i = !1;
            for ("object" == typeof t && (i = j(t)); n && !(i ? i.indexOf(n) >= 0 : Q.matches(n, t));) n = n !== e && !r(n) && n.parentNode;
            return j(n)
        },
        parents: function(t) {
        ...
        css: function(e, n) {
            ...
            if ("string" == t(e)) n || 0 === n ? a = u(e) + ":" + f(e, n) : this.each(function() {
                ...
                for (E in e) e[E] || 0 === e[E] ? a += u(E) + ":" + f(E, e[E]) + ";" : this.each(function() {
                    this.style.removeProperty(u(E))
                });
            return this.each(function() {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || A.body; t && !_.test(t.nodeName) && "static" == j(t).css("position");) t = t.offsetParent;
                return t
            })
        }
    ...
    }), Q.Z.prototype = j.fn, Q.uniq = O, Q.deserializeValue = b, j.zepto = Q, j
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function(t) {
        ...
        C.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
            ...
            r(i), i.crossDomain || (n = y.createElement("a"), n.href = i.url, n.href = n.href, i.crossDomain = C.protocol + "//" + C.host != n.protocol + "//" + n.host), i.url || (i.url = window.location.toString()), h(i);
            var p = i.dataType,
                d = /\?.+=\?/.test(i.url);
            ...
            var v, b = i.accepts[p],
                ...
                j = i.xhr(),
                O = j.setRequestHeader;
            if (c && c.promise(j), i.crossDomain || w("X-Requested-With", "XMLHttpRequest"), w("Accept", b || "*/*"), (b = i.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(b)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && w("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers)
            ...
            if (j.setRequestHeader = w, j.onreadystatechange = function() {
                    if (4 == j.readyState) {
                        ...
                        if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == E) {
                            ...
                            n ? s(n, "parsererror", j, i, c) : a(e, j, i, c)
                        } else s(j.statusText || null, j.status ? "error" : "abort", j, i, c)
                    }
                }, o(j, i) === !1) return j.abort(), s(null, "abort", j, i, c), j;
            if (i.xhrFields)
                for (g in i.xhrFields) j[g] = i.xhrFields[g];
            var T = "async" in i ? i.async : !0;
            j.open(i.type, i.url, T, i.username, i.password);
            for (g in x) O.apply(j, x[g]);
            return i.timeout > 0 && (v = setTimeout(function() {
                j.onreadystatechange = u, j.abort(), s(null, "timeout", j, i, c)
    ...
    function(t, e) {
        ...
        "use strict";
        var e, n, r, i = {},
            o = !!document.querySelector && !!t.addEventListener,
            a = {
                speed: 500,
            ...
            u = function(t, e) {
                for (var n = e.charAt(0); t && t !== document; t = t.parentNode)
                    if ("." === n) {
                        if (t.classList.contains(e.substr(1))) return t
                    } else if ("#" === n) {
                    if (t.id === e.substr(1)) return t
                } else if ("[" === n && t.hasAttribute(e.substr(1, e.length - 2))) return t;
                return !1
            },
            l = function(t) {
            ...
            f = function(t) {
                for (var e, n = String(t), r = n.length, i = -1, o = "", a = n.charCodeAt(0); ++i < r;) {
                    if (e = n.charCodeAt(i), 0 === e) throw new InvalidCharacterError("Invalid character: the input contains U+0000.");
                    o += e >= 1 && 31 >= e || 127 == e || 0 === i && e >= 48 && 57 >= e || 1 === i && e >= 48 && 57 >= e && 45 === a ? "\\" + e.toString(16) + " " : e >= 128 || 45 === e || 95 === e || e >= 48 && 57 >= e || e >= 65 && 90 >= e || e >= 97 && 122 >= e ? n.charAt(i) : "\\" + n.charAt(i)
                }
                return o
            },
            h = function(t, e) {
            ...
            p = function(t, e, n) {
                var r = 0;
                if (t.offsetParent)
                    do r += t.offsetTop, t = t.offsetParent; while (t);
                return r = r - e - n, r >= 0 ? r : 0
            },
            d = function() {
            ...
            g = function(e, n) {
                history.pushState && (n || "true" === n) && history.pushState(null, null, [t.location.protocol, "//", t.location.host, t.location.pathname, t.location.search, e].join(""))
            };
        i.animateScroll = function(e, n, i) {
            var o = c(o || a, i || {}),
                s = m(e ? e.getAttribute("data-options") : null);
            o = c(o, s), n = "#" + f(n.substr(1));
            var u = "#" === n ? document.documentElement : document.querySelector(n),
                v = t.pageYOffset;
            r || (r = document.querySelector("[data-scroll-header]"));
            var y, b, x, w = null === r ? 0 : l(r) + r.offsetTop,
                E = p(u, w, parseInt(o.offset, 10)),
                j = E - v,
                S = d(),
                C = 0;
            g(n, o.updateURL);
            var O = function(r, i, a) {
                    var s = t.pageYOffset;
                    (r == i || s == i || t.innerHeight + s >= S) && (clearInterval(a), u.focus(), o.callbackAfter(e, n))
                },
                T = function() {
                    C += 16, b = C / parseInt(o.speed, 10), b = b > 1 ? 1 : b, x = v + j * h(o.easing, b), t.scrollTo(0, Math.floor(x)), O(x, E, y)
                },
                N = function() {
                    o.callbackBefore(e, n), y = setInterval(T, 16)
                };
            0 === t.pageYOffset && t.scrollTo(0, 0), N()
        };
        var v = function(t) {
                var n = u(t.target, "[data-scroll]");
                n && "a" === n.tagName.toLowerCase() && (t.preventDefault(), i.animateScroll(n, n.hash, e))
            },
            y = function(t) {
                n || (n = setTimeout(function() {
                    n = null, headerHeight = null === r ? 0 : l(r) + r.offsetTop
                }, 66))
            };
        return i.destroy = function() {
            e && (document.removeEventListener("click", v, !1), t.removeEventListener("resize", y, !1), e = null, n = null, r = null)
        }, i.init = function(n) {
            o && (i.destroy(), e = c(a, n || {}), r = document.querySelector("[data-scroll-header]"), document.addEventListener("click", v, !1), r && t.addEventListener("resize", y, !1))
        }, i
    }),
    function(t) {
        t.fn.simpleJekyllSearch = function(e) {
            ...
            function r(e) {
                ...
                return t.each(c, function(t, r) {
                    for (var t = 0; t < s.length; t++) void 0 !== r[s[t]] && -1 !== r[s[t]].toLowerCase().indexOf(e.toLowerCase()) && (n.push(r), t = s.length)
                }), n
            }

            function i(e) {
                o(), l.append(t(a.searchResultsTitle)), e.length ? t.each(e, function(e, n) {
                    if (e < a.limit) {
                        for (var r = a.template, e = 0; e < s.length; e++) {
                            var i = new RegExp("{" + s[e] + "}", "g");
                            r = r.replace(i, n[s[e]])
                        }
                        l.append(t(r))
                    }
                }) : l.append(a.noResults)
            }
            ...
            var a = t.extend({
                    ...
                    jsonFormat: "title,category,tags,url,date",
                ...
                u = this,
                l = t(a.searchResults);
            a.jsonFile.length && l.length && t.ajax({
                type: "GET",
                url: a.jsonFile,
                dataType: "json",
    ...
    function(t, e, n) {
        ...
        r.dothis.on("click", function() {
            t(".search-wrapper").toggleClass("active"), r.searchform.toggleClass("active"), r.searchform.find("input").focus(), r.canvas.toggleClass("search-overlay"), t(".search-field").simpleJekyllSearch()
